...
Due to the size of our data set, we've validated OLS Large Sample assumptions.

Additionaly, we still ran additional tests against Classical Linear Model assumptions. Regardless of these results, 
